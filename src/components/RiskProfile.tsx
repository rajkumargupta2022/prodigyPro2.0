  ...
  const saveRiskData = async () => {
    ...
    if (adminUser?.ucc) {
      ...
      try {
        let body = {
          ucc: adminUser?.ucc,
          risk: option <= 4 ? 1 : option >= 9 ? 3 : 2
        }
        await postRequest(endPoints.saveRiskProfile, body)
        navigate("/risk-result", { state: { score: option } })
              ...
              <div className="col-lg-8 col-sm-12">
                <div className="row mb-4">
                  <div className="progress col px-0 mx-1 my-2 progressBg" role="progressbar" style={{ height: "4px" }} aria-valuemin={0} aria-valuemax={100}>
                    ...
                    <div className="progress-bar bg-white" style={{ width: `${question >= 1 ? "100%" : "0%"}` }}></div>
                  </div> <div className="progress col px-0 mx-1 my-2 progressBg" role="progressbar" style={{ height: "4px" }} aria-valuemin={0} aria-valuemax={100}>
                    <div className="progress-bar bg-white" style={{ width: `${question >= 2 ? "100%" : "0%"}` }}></div>
                  </div> <div className="progress col px-0 mx-1 my-2 progressBg" role="progressbar" style={{ height: "4px" }} aria-valuemin={0} aria-valuemax={100}>
                    <div className="progress-bar bg-white" style={{ width: `${question >= 3 ? "100%" : "0%"}` }}></div>
                  </div>
                </div>
                {question > 0 && (
