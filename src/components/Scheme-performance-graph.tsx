...
import { schemeSummaryKeys } from '../pages/data-interfaces/portfolio';
// import SwitchConfirmation from './SwitchConfirmation';
interface SchemePerformanceProp {
  show: boolean;
  setShow: (show: boolean) => void;
  // schemeList:schemeSummaryKeys[]
}

const SchemePerformanceGraph: React.FC<SchemePerformanceProp> = ({ show, setShow }) => {
...
export default SchemePerformanceGraph;