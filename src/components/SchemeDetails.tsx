      ...
      >
        ...
        <Modal.Body className='modal-bg'>
          <Card className='rounded-4 shadow-lg border-0 mb-2'>
            <Card.Header className='scheme-bg border-0'>SBI Liquid Fund - Regular (G)</Card.Header>
            <Card.Body>
              <div className="row container-fluid">
                ...
                <div className="col col-md-4 text-end fs12px"><button type="button" className="btn scheme-bg rounded-5 logoBlueColor popularButton">Recommended</button></div>

                <div className="col p-0">
                  <small className='fs12px'>INVESTED</small>
                  <p className="fs12px text-dark"><CurrencyRupee />60.2K</p>
                </div>
                <div className="col"><small className='fs12px'>Current</small>
                <p className="fs12px text-dark"><CurrencyRupee />60.2K</p></div>
              </div>
              <div className="col p-0 fs12px logoBlueColor crPointer" onClick={()=>setOpenCreateFolio(true)}>
                     Change Folio
              </div>
            </Card.Body>
          </Card>
        ...
        <Modal.Footer className='modal-bg'>
          <Button className='customButton ' onClick={handleConfirmation}>Continue</Button>
        </Modal.Footer>
      </Modal>
      <CreateNewFolio show={openCreateFolio} setShow={setOpenCreateFolio}/>
      <InvetmentConfirmation show={openInvestmentConfirmation} setShow={setOpenInvestmentConfirmation}/>
    </>
  );
}
