  ...
  return (
    <main className="col-md-9 ms-sm-auto col-lg-9 px-md-4 py-4">
      ...
      <div className="d-flex  mb-3 align-items-center">
        <img src={imageUrl + location?.state?.accord_amc_code + ".png"} alt="image not found" height={40} width={40} className="rounded" />
      ...
      {(orderDetail?.installments?.length ?? 0) > 0 ? orderDetail?.installments.map((item) => {
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <h6 style={{ margin: 0 }}>{getOrdinal(item.installment)} SIP Instalment</h6>
            </div>
