      ...
      <div className="row login_hight_fixed">
        ...
        <div className="col-12 col-md-6 align-self-center position-relative">
          ...
          <div className="mrgin_With20">
            ...
            <form className="" action="#" onSubmit={checkPanKyc}>
              <p className="pb-1 fs12px">Know it within the seconds</p>

              <label className="form-label fs12px">PAN NUMBER</label>
              <div className="input-group mb-3">
                <input type="text" value={userPan ?? ''} onChange={panHandler} className="form-control mx-1 rounded" placeholder="Enter Pan" />
              </div>
              <h4 className="fs14px congratesColor font-weight-bold">Congratulations! 🎉 You are KYC Compliant</h4>
              <h4 className="congratesColor font-weight-bold errorColor">Your are not KYC Compliant</h4>
              ...
              <button type="submit" className="customButton col-12 mt-3">Proceed</button>
            </form>
          </div>
        </div>
      </div>
