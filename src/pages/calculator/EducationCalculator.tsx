      ...
      <div className="container px-4 my-4" >
        <div className="row">
          <div className="col-12 align-items-start mb-3">
            ...
            <p className="fs14px">It helps you to see plans for the future expenditure of your child higher education.</p>
          </div>
              ...
              <div className="card border-0 shadow p-2">
                <div className="card-body">
                  <form>
                    ...
                    <RangeBar label={"COLLEGE START AT AGE"} maxLimit={30}  value={startCollegeAge} setValue={setStartCollegeAge}/>
                    <RangeBar label={"DURATION OF EDUCATION"} maxLimit={8}  value={durationOfEducation} setValue={setDurationOfEducation}/>
                    <div className="form-group my-2">
                      <label htmlFor="exampleInputEmail1" className="fs12px">APPROX CURRENT COST PER YEAR</label>
                      <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="₹5,00,000" />
                    </div>
                    <div className="form-group my-2">
            ...
            <div className="col-lg-6 co-sm-12 col-md-12 mTopForMobile">
              <div className="card border-0 shadow p-2">
                <div className="card-body">
                  ...
                  <p className="fs12px mb-0 mt-3">CORPUS REQUIRED AT START OF COLLEGE</p>
