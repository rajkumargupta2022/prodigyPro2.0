        ...
        <div className="personal_form_container">
          ...
          <div className="row pt-4">
            <div className="col-lg-6 col-md-6 col-sm-12 align-items-center mb-3">
                  ...
                  <div className="col-12 align-self-center h-100">
                    <small className="fw-semibold">
                      ...
                      <span className="fs12px ms-1">
                        As on {currentDateInStringNumber()}
                      </span>
                    </small>

                    <h3 className="fw-bold mt-2">
                      <CurrencyRupee className="mb-1" /> 1,12,817.54
                    </h3>
                    ...
                    <div className="row justify-content-center mt-3 w-75 mx-auto">
                      <div className="col-md-12">
                        <div className="d-flex justify-content-between">
                          ...
                          <span className="fw-semibold">4500</span>
                        </div>
                        <hr />
                        <div className="d-flex justify-content-between">
                          <small>Surplus</small>
                          <span className="fw-semibold">5622</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* <div className="scheme-bg rounded-2 mt-2">
                  <div className="d-flex align-items-center p-2 fs14px">
                    <p className="mb-0">
                      You just missed ₹17,000 in MF Savings returns!
                    </p>
                    <button
                      className="customButton px-3 ms-auto"
                      onClick={() => setOpenManageAccounts(true)}
                    >
                      Invest Surplus
                    </button>
                  </div>
                ...
                <div className="borderColor p-3 rounded-top-3 bg-white">
                  <div className="row justify-content-between align-items-center">
                    <div className="col-md-7">
                      <div className="d-flex">
                        ...
                        <div className="ms-2 mt-1">
                          <h6 className="mb-0">Bank .... {bankId}</h6>
                    ...
                    <div className="col-md-4 text-end">
                      <p className="text-dark fs15px">₹1,23,175.23</p>
                    </div>
                  ...
                  <div className="row mt-3">
                    <div className="col-lg-4">
                      ...
                      <div className="d-flex justify-content-between">
                        <small>Surplus</small>
                        <span className="fw-semibold">₹1,000</span>
                      </div>
                    </div>
                  </div>
                </div>
