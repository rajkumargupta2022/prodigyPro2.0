      ...
      {installmentDetails?.transaction_id ? <>
        ...
        <div className="p-4 shadow-sm bg-white border-0 rounded-4 mb-2">
          ...
          <div className="d-flex justify-content-between mb-2">
            <span className="text-secondary">{location.state?.from === "orders" ? "REDEMPTION VALUE" : "TRANSACTION VALUE"}</span>
            <span className="value-font2">{installmentDetails?.redemption_amount ? "₹" + installmentDetails?.redemption_amount : installmentDetails?.redemption_units ? installmentDetails?.redemption_units : "All Units"}</span>
          </div>
          {installmentDetails?.investment_type && 
          <div className="d-flex justify-content-between mb-2">
          ...
          <div className="d-flex justify-content-between mb-2">
            ...
            <span className="value-font2">{installmentDetails?.bank_account_number}</span>
          </div>}
          {/* <div className="d-flex justify-content-between mb-2">
