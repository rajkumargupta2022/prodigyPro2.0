...
function RedumptionOrders() {
  const navigate = useNavigate();

  const fetchRedemptionOrders = useCallback(async (pageNum: number) => {
  ...
  const {
    ...
    hasMore,
    loaderRef,
  } = useInfinitePagination<RedemptionKeys>({
    fetchData: fetchRedemptionOrders,
  });
...
export default RedumptionOrders;
