      ...
      <div className="container px-4 mt-4">
        <div className="row justify-content-md-center">
          ...
          >
            ...
            <h6 className="text-white">Your IIN application has been submitted successfully.</h6>
            <small className="text-white">To activate your IIN, you need to approve IIN & FATCA authorization link for all the holder(s) sent
on respective mail id(s)</small>

            {/* Animated Risk Meter with Needle */}
     

            <div className="mx-lg-4 mt-2 mb-5">
              <small className="text-white fs12px">IIN will get approved within 2 working days</small>
            </div>
